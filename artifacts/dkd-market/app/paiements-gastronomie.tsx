...
const PAYMENTS: Payment[] = [
  { id: "g1", name: "Kofi Mensah",       initials: "KM", color: "#EC4899", service: "Plat traiteur mariage (30 pers.)", amount: 150000, date: "13 mars 2026", status: "attente" },
  { id: "g2", name: "Aïssatou Ba",       initials: "AB", color: "#A855F7", service: "Livraison repas hebdomadaire",     amount: 45000,  date: "13 mars 2026", status: "attente" },
  { id: "g3", name: "Ibrahim Traoré",    initials: "IT", color: "#F59E0B", service: "Menu spécial anniversaire",        amount: 80000,  date: "12 mars 2026", status: "attente" },
  { id: "g4", name: "Mariam Coulibaly",  initials: "MC", color: "#22C55E", service: "Commande brochettes + thiébou",   amount: 35000,  date: "11 mars 2026", status: "paye"    },
  { id: "g5", name: "Mamadou Diallo",    initials: "MD", color: "#3B82F6", service: "Traiteur séminaire entreprise",   amount: 220000, date: "09 mars 2026", status: "paye"    },
];

type Tab = "attente" | "paye";

export default function PaiementsGastronomiePage() {
      ...
      <View style={[s.header, { paddingTop: insets.top + 10, backgroundColor: dynHeader, borderBottomColor: dynBorder }]}>
        ...
        <View style={s.headerCenter}>
          ...
          <View>
            ...
            <Text style={[s.headerSub, { color: dynSub }]}>Gastronomie</Text>
          </View>
        </View>
      </View>
