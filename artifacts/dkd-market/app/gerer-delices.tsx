  ...
  return (
    <View style={[s.root, { backgroundColor: dynBG, paddingTop: insets.top }]}>
      ...
      <View style={[s.header, { backgroundColor: dynHeader, borderBottomColor: dynBorder }]}>
        ...
        <TouchableOpacity style={[s.addBtn, { backgroundColor: ACCENT }]} onPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium); router.push("/publication-gastronomia" as any); }} activeOpacity={0.85}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<View style={s.empty}><Ionicons name="fast-food-outline" size={48} color={dynSub} /><Text style={[s.emptyTitle, { color: dynSub }]}>Aucun délice</Text></View>}
      />
    </View>
  );
}
