...
export default function RayonsMarchePage() {
    ...
    <View style={[s.root, { backgroundColor: dynBG, paddingTop: insets.top }]}>
      <View style={[s.header, { backgroundColor: dynHeader, borderBottomColor: dynBorder }]}>
        ...
        <View style={s.headerCenter}>
          ...
          <Text style={[s.headerTitle, { color: dynText }]}>Marché</Text>
        </View>
        <View style={{ width: 32 }} />
      </View>
      ...
      <View style={s.center}>
        ...
        <Text style={[s.emptySub, { color: dynSub }]}>La section Marché est en cours de préparation.</Text>
      </View>
    </View>
  );
}
