...
const COLLAB_KEY   = "@dkd:supermarche_collaborateurs";

type Conv = { id: string; name: string; initials: string; color: string; role?: string };

const DEFAULT_CONTACTS: Conv[] = [
  { id: "sc1", name: "Kofi Asante",       initials: "KA", color: "#F97316", role: "Caissier" },
  { id: "sc2", name: "Binta Diallo",      initials: "BD", color: "#8B5CF6", role: "Magasinier" },
  { id: "sc3", name: "Sékou Koné",        initials: "SK", color: "#22C55E", role: "Livreur" },
  { id: "sc4", name: "Rokhaya Mbaye",     initials: "RM", color: "#3B82F6", role: "Gestionnaire" },
];

export default function CollaborateurSupermarchePage() {
      ...
      <View style={[s.header, { paddingTop: insets.top + 10, backgroundColor: dynHeader, borderBottomColor: dynBorder }]}>
        ...
        <View style={s.headerCenter}>
          ...
          <View>
            ...
            <Text style={[s.headerSub, { color: dynSub }]}>Super Marché</Text>
          </View>
        </View>
      </View>
