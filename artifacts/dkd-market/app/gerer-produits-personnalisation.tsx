  ...
  return (
    <View style={[s.root, { backgroundColor: dynBG }]}>
      ...
      <View style={[s.header, { paddingTop: insets.top + 10, backgroundColor: dynHeader, borderBottomColor: dynBorder }]}>
        ...
        <TouchableOpacity style={[s.addBtn, { backgroundColor: ACCENT }]} onPress={() => { Haptics.selectionAsync(); router.push("/publication-personnalisation" as any); }} activeOpacity={0.85}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<View style={s.empty}><Ionicons name="color-palette-outline" size={48} color={dynSub} /><Text style={[s.emptyTitle, { color: dynSub }]}>Aucun produit</Text></View>}
      />
    </View>
  );
}
