...
const PAYMENTS: Payment[] = [
  { id: "p1", name: "Aminata Koné",       initials: "AK", color: "#06B6D4", service: "Broderie personnalisée",     amount: 45000,  date: "13 mars 2026", status: "attente" },
  { id: "p2", name: "Moussa Traoré",      initials: "MT", color: "#8B5CF6", service: "Retouche robe de mariée",   amount: 120000, date: "13 mars 2026", status: "attente" },
  { id: "p3", name: "Aïssatou Diallo",    initials: "AD", color: "#F59E0B", service: "Création tenue sur-mesure", amount: 85000,  date: "12 mars 2026", status: "attente" },
  { id: "p4", name: "Ibrahim Coulibaly",  initials: "IC", color: "#22C55E", service: "Broderie logo",              amount: 30000,  date: "11 mars 2026", status: "paye"    },
  { id: "p5", name: "Fatou Sow",          initials: "FS", color: "#EC4899", service: "Robe de soirée",             amount: 95000,  date: "10 mars 2026", status: "paye"    },
  { id: "p6", name: "Koffi Mensah",       initials: "KM", color: "#34D399", service: "Uniforme d'entreprise",     amount: 200000, date: "08 mars 2026", status: "paye"    },
];

type Tab = "attente" | "paye";

export default function PaiementsPersonnalisationPage() {
      ...
      <View style={[s.header, { paddingTop: insets.top + 10, backgroundColor: dynHeader, borderBottomColor: dynBorder }]}>
        ...
        <View style={s.headerCenter}>
          ...
          <View>
            ...
            <Text style={[s.headerSub, { color: dynSub }]}>Personnalisation</Text>
          </View>
        </View>
      </View>
...
const s = StyleSheet.create({
  ...
  amountRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderTopWidth: 1, paddingTop: 10, marginBottom: 10 },
  amountLabel:{ fontFamily: "Poppins_400Regular", fontSize: 12 },
  amountValue:{ fontFamily: "Poppins_700Bold", fontSize: 15 },
  confirmBtn:{ flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, borderRadius: 10, paddingVertical: 9 },
  confirmBtnText:{ fontFamily: "Poppins_700Bold", fontSize: 13, color: "#fff" },
});
