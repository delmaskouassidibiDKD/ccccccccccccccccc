...
const METHODS: Method[] = [
  {
    ...
    sub: "Publiez en quelques secondes : nom, prix et photo. Idéal pour aller vite !",
    tags: ["Ultra-rapide", "3 champs", "Minimal"],
    badge: "NOUVEAU",
    route: "/quick-publish?context=personnalisation",
  },
  {
    key: "wholesale",
    icon: "cube-outline",
    color: ACCENT,
    label: "Vente en gros",
    sub: "Proposez vos créations avec un prix grossiste pour les revendeurs et commandes en volume.",
    tags: ["Revendeurs", "Prix gros", "Volume"],
    route: "/add-product?saleMode=wholesale_only",
  },
];

export default function PublicationPersonnalisationPage() {
    ...
    <View style={[s.root, { backgroundColor: dynBG }]}>
      ...
      <View style={[s.header, { paddingTop: insets.top + 10, backgroundColor: dynHeader, borderBottomColor: dynBorder }]}>
        ...
        <View style={s.headerCenter}>
          ...
          <View>
            <Text style={[s.headerTitle, { color: dynText }]}>Publier un article</Text>
      ...
      >
        <View style={[s.introBox, { backgroundColor: ACCENT + "12", borderColor: ACCENT + "30" }]}>
          ...
          <Text style={[s.introText, { color: isDark ? "#67E8F9" : "#0E7490" }]}>
            Personnalisation propose deux modes : une publication express pour aller vite, ou une vente en gros pour les revendeurs et commandes en volume.
          </Text>
        </View>
